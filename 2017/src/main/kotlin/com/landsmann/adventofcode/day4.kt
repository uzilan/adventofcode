...
fun highEntropyPassphrases(strings: List<String>): Int =
        strings.count { isValid(it) }
...
fun main(args: Array<String>) {
    val lines = """sayndz zfxlkl attjtww cti sokkmty brx fhh suelqbp
...
kebx eild nrskdr meja jxczomh gcne""".split("\n")

    println(highEntropyPassphrases(lines))
}